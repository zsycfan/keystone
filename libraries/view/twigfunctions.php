 ...
 * @return mixed
 */
function twig_fn_sess_val($name, $default = '')
{
 ...
 * @return string
 */
function twig_fn_url_to($route)
{
	$args = func_get_args();
	array_shift($args);
	return URL::to_action($route, $args, false);
}
 ...
 * @return string
 */
function twig_fn_secure_url_to($route)
{
	$args = func_get_args();
	array_shift($args);
	return URL::to_action($route, $args, true);
}
 ...
 * @return string
 */
function twig_fn_url_to_route($route)
{
	$args = func_get_args();
	array_shift($args);
	return URL::to_route($route, $args);
}
