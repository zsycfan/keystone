...
class View extends Laravel\View
{
    ...
    public function render()
    {
        ...
        try
        {
            ...
            $files = Laravel\Config::get('keystone::view.include');
            ...
            $cache = Laravel\Config::get('keystone::view.cache');
            $debug = Laravel\Config::get('keystone::view.debug');
            $autoreload = Laravel\Config::get('keystone::view.autoreload');
            $functions = Laravel\Config::get('keystone::view.functions', array());
            $filters = Laravel\Config::get('keystone::view.filters', array());
